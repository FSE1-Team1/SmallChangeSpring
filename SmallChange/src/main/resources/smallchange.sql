...
INSERT INTO SC_INSTRUMENT("instrument_id","instrument_description","external_id","external_id_type","min_quantity","max_quantity","category_id") VALUES ('APP','USA, Note 2.5 31jan2021 2Y','9128285X4','CUSIP',1000,10000,'GOVT');
INSERT INTO SC_PRICE ("instrument_id","bid_price","ask_price","timestamp") VALUES ('APP',2.5,3.5,TO_DATE('2022-01-22', 'yyyy-mm-dd'));
INSERT INTO SC_INSTRUMENT("instrument_id","instrument_description","external_id","external_id_type","min_quantity","max_quantity","category_id") VALUES ('Google','USA, Note 2.5 31jan2021 2Y','9128285X4','CUSIP',1,100000,'GOVT');
INSERT INTO SC_PRICE ("instrument_id","bid_price","ask_price","timestamp") VALUES ('Google',0.05,5.5,TO_DATE('2022-01-22', 'yyyy-mm-dd'));

INSERT INTO SC_INSTRUMENT("instrument_id","instrument_description","external_id","external_id_type","min_quantity","max_quantity","category_id") VALUES ('Tata','USA, Note 2.5 31jan2021 2Y','9128285X4','CUSIP',500,5000,'GOVT');
INSERT INTO SC_PRICE ("instrument_id","bid_price","ask_price","timestamp") VALUES ('Tata',0.1,1.5,TO_DATE('2022-01-22', 'yyyy-mm-dd'));

INSERT INTO SC_INSTRUMENT("instrument_id","instrument_description","external_id","external_id_type","min_quantity","max_quantity","category_id") VALUES ('Samsung','USA, Note 2.5 31jan2021 2Y','9128285X4','CUSIP',50,500000,'GOVT');
INSERT INTO SC_PRICE ("instrument_id","bid_price","ask_price","timestamp") VALUES ('Samsung',4.0,4.5,TO_DATE('2022-01-22', 'yyyy-mm-dd'));

INSERT INTO SC_INSTRUMENT("instrument_id","instrument_description","external_id","external_id_type","min_quantity","max_quantity","category_id") VALUES ('TZW','USA, Note 2.5 31jan2021 2Y','9128285X4','CUSIP',5,1500,'GOVT');
INSERT INTO SC_PRICE ("instrument_id","bid_price","ask_price","timestamp") VALUES ('TZW',0.34,0.5,TO_DATE('2022-01-22', 'yyyy-mm-dd'));
