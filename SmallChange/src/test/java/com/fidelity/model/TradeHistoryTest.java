...
class TradeHistoryTest {
	...
	void setUp() throws Exception {
		tradeHistory = new TradeHistory("123ab", BigDecimal.TEN, BigDecimal.ONE, "buy", "1234", "td123", BigDecimal.TEN,Timestamp.valueOf(timeDate));
	}
	@AfterEach
	...
	void testObjectCreation_passing_null_throws_Exception() {
		assertThrows(IllegalArgumentException.class,()-> {
			new TradeHistory(null, BigDecimal.TEN, BigDecimal.ONE, "1234", "1234", "td123",  BigDecimal.TEN,Timestamp.valueOf(timeDate));
		});
		}
	...
	void testObjectEquality() {
		TradeHistory tradeHistory1 = new TradeHistory("123ab", BigDecimal.TEN, BigDecimal.ONE, "buy", "1234", "td123", BigDecimal.TEN,Timestamp.valueOf(timeDate));
		assertEquals(tradeHistory, tradeHistory1);
		
	}
	@Test
	void testObjectInquality() {
		TradeHistory tradeHistory1 = new TradeHistory("13ab", BigDecimal.TEN, BigDecimal.ONE, "buy", "1234", "td123",  BigDecimal.TEN,Timestamp.valueOf(LocalDateTime.now()));
