...
class ClientTest {
	...
	void setUp() {
		...
		country = "USA";
		postalCode = "600091";
		identification = new ClientIdentification("1", "SSN", "123456");
	...
	void test_Client_HashCode() {
		Client client1 = new Client(id, firstName, lastName, dateOfBirth, email, password, country, postalCode,
				identification);
		Client client2 = new Client(id, firstName, lastName, dateOfBirth, email, password, country, postalCode,
				identification);
	...
	void test_Client_InEquality() {
		assertNotEquals(
				new Client("2", firstName, lastName, dateOfBirth, email, password, country, postalCode, identification),
				client);
	}
	...
	void test_toString() {
		assertEquals(client.toString(),
				"Client [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", dateOfBirth="
						+ dateOfBirth + ", email=" + email + ", password=" + password + ", country=" + country
						+ ", postalCode=" + postalCode + ", identification=" + identification.toString() + "]");
	}
